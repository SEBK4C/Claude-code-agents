...
**Stage:** 5 (IF ERRORS)
**Role:** Third debugger agent - continues from debugger-2
**Re-run Eligible:** YES
**Instance:** 3 of 11
...
- **Recommended Next Step:** [Re-run test-agent] / [REQUEST: debugger-4 for remaining issues]
