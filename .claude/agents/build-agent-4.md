---
name: build-agent-4
description: CONTINUATION agent. Continues work from build-agent-3. Fresh budget. Passes incomplete work to build-agent-5.
...
**Your budget is FRESH** - continue where build-agent-3 stopped.

If you exhaust your budget before finishing, output what's done for build-agent-5.
