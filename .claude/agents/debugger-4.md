...
**Stage:** 5 (IF ERRORS)
**Role:** Fourth debugger agent - continues from debugger-3
**Re-run Eligible:** YES
**Instance:** 4 of 11
...
- **Recommended Next Step:** [Re-run test-agent] / [REQUEST: debugger-5 for remaining issues]
...
- [ ] Continuation context acknowledged (what debugger-3 completed)
- [ ] Decision documented (continue to debugger-5 or proceed to test-agent)
