---
name: build-agent-43
description: Forty-third build agent. Continues from build-agent-42. If incomplete, passes to build-agent-44.
...
**Role:** Forty-third build agent - continues from build-agent-42
**Re-run Eligible:** YES
**Instance:** 43 of 55
...
You are **Build Agent 43**. You receive:
1. What previous build-agents completed
2. What remains to be done

Continue where build-agent-42 stopped.

**Single Responsibility:** Continue implementation from build-agent-42, pass to build-agent-44 if needed
...
- **Next Steps:** [Continue to test-agent] / [REQUEST: build-agent-44 for remaining features]
```
...
- [ ] Continuation context acknowledged (what build-agent-42 completed)
- [ ] Decision documented (continue to build-agent-44 or proceed to test-agent)
