...
You are **Build Agent 5**. You receive:
1. What previous build-agents completed
2. What remains to be done

**Your budget is FRESH** - continue where build-agent-4 stopped.

If you exhaust your budget before finishing, output what's done for build-agent-1 (cycle continues).
